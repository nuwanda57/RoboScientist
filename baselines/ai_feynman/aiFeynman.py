...
import sys
import csv
from baselines.ai_feynman.S_polyclean_file import polyfit
from baselines.ai_feynman.S_NN_sep_mult import NN_sep_mult
from baselines.ai_feynman.S_NN_sep_add import NN_sep_add
from baselines.ai_feynman.S_NN_equal_vars import NN_equal_vars
from baselines.ai_feynman.S_brute_force import brute_force
from baselines.ai_feynman.S_get_inverse import get_inverse
from baselines.ai_feynman.S_get_log import get_log
from baselines.ai_feynman.S_get_exp import get_exp
from baselines.ai_feynman.S_get_sin import get_sin
from baselines.ai_feynman.S_get_asin import get_asin
from baselines.ai_feynman.S_get_cos import get_cos
from baselines.ai_feynman.S_get_acos import get_acos
from baselines.ai_feynman.S_get_tan import get_tan
from baselines.ai_feynman.S_get_atan import get_atan
from baselines.ai_feynman.S_get_squared import get_squared
from baselines.ai_feynman.S_get_sqrt import get_sqrt
from baselines.ai_feynman.S_create_new_file_for_NN_add import create_new_file_for_NN_add
from baselines.ai_feynman.S_create_new_file_for_NN_mult import create_new_file_for_NN_mult
from baselines.ai_feynman.S_create_new_file_for_NN_eq_vars import create_new_file_for_NN_eq_vars
from baselines.ai_feynman.S_translational_symmetry_minus import translational_symmetry_minus
from baselines.ai_feynman.S_translational_symmetry_multiply import translational_symmetry_multiply
from baselines.ai_feynman.S_translational_symmetry_divide import translational_symmetry_divide
from baselines.ai_feynman.S_translational_symmetry_plus import translational_symmetry_plus
from baselines.ai_feynman.S_NN_train import NN_train
from baselines.ai_feynman.S_generate_new_dimRed_xlsx_file_translation import generate_new_dimRed_xlsx_file_translation
from baselines.ai_feynman.S_replace_variables import replace_variables
from baselines.ai_feynman.S_NN_eval import NN_eval
from baselines.ai_feynman.S_generate_new_dimRed_xlsx_file_equal_vars import generate_new_dimRed_xlsx_file_equal_vars
from baselines.ai_feynman.S_get_RMS import get_RMS
from baselines.ai_feynman.S_create_variables_file import create_variables_file

from baselines.ai_feynman.S_change_input import input_divide_2
from baselines.ai_feynman.S_change_input import input_multiply_2
from baselines.ai_feynman.S_change_input import input_exp
from baselines.ai_feynman.S_change_input import input_log
from baselines.ai_feynman.S_change_input import input_sqrt
from baselines.ai_feynman.S_change_input import input_squared
from baselines.ai_feynman.S_change_input import input_inverse
from baselines.ai_feynman.S_change_input import input_sin
from baselines.ai_feynman.S_change_input import input_asin
from baselines.ai_feynman.S_change_input import input_cos
from baselines.ai_feynman.S_change_input import input_acos
from baselines.ai_feynman.S_change_input import input_tan
from baselines.ai_feynman.S_change_input import input_atan

from baselines.ai_feynman.S_try_bf_polyfit import try_bf_polyfit
from baselines.ai_feynman.S_generate_new_dimRed_xlsx_file_transf_input import generate_new_dimRed_xlsx_file_transf_input
from baselines.ai_feynman.S_generate_new_dimRed_xlsx_file_separable import generate_new_dimRed_xlsx_file_separable
import pandas as pd
